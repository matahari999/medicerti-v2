...
import MediLoadingAnimation from '@/components/MediLoadingAnimation';
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid lg:grid-cols-5 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            {showOfficialSource && (
              <div className="px-5 pb-5 border-t border-gray-100">
                ...
                <textarea value={officialSourceText} onChange={e => setOfficialSourceText(e.target.value)}
        ...
        <div className="lg:col-span-3 space-y-4">
          <div className="bg-white rounded-2xl border border-gray-200 p-5">
            <label className="block text-sm font-semibold text-gray-700 mb-2">문서 요청 내용 *</label>
            <div className="flex flex-wrap gap-1.5 mb-3">
              {QUICK_EXAMPLES.map((ex, i) => (
                <button key={i} onClick={() => setUserRequest(ex)}
