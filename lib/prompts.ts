...
반드시 아래 JSON 스키마 구조로만 응답하라:
{
  ...
  "draftDocument": {
    ...
    "purpose": "목적 (2~3문장)",
    "scope": "적용 범위",
    "definitions": ["용어1: 정의", "용어2: 정의"],
    "responsibilities": ["담당자1: 역할", "담당자2: 역할"],
    "procedure": ["1. 절차1", "2. 절차2", "3. 절차3", "4. 절차4", "5. 절차5"],
  ...
  "disclaimer": "본 문서는 AI가 생성한 실무 참고용 초안입니다. 최종 사용 전 반드시 병원 내부 검토, 최신 의료기관평가인증원 공식 기준 확인, 법무·의료진 검토를 거치시기 바랍니다."
}`;
